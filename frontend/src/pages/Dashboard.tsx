...
function hasValue(value: unknown): boolean {
  ...
  return normalized !== "" && normalized !== "n/a" && normalized !== "na" && normalized !== "not available" && normalized !== "null" && normalized !== "undefined";
}

function Field({ label, value }: { label: string; value: string | number | null | undefined }) {
  if (!hasValue(value)) return null;
  return <div className="field-item"><span>{label}</span><strong>{value}</strong></div>;
}
