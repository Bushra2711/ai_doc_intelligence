...
export default function DashboardAnalytics({ token }: Props) {
  ...
  if (error) return <section className="analytics-grid"><div className="panel analytics-panel"><p className="eyebrow">KPI ANALYTICS</p><h3>Dashboard analytics</h3><div className="alert error">{error}</div><AuditTrail token={token} /></div></section>;
